...
- TODO Sharon: list your IT skills, certifications, projects, or relevant coursework/self-study so CareerBot IT can build a truthful resume — do not apply until this is filled with real, verifiable information.
- Languages:
- Frameworks:
- Cloud / DevOps:
- Databases:
...
- Inbox CareerBot IT may read:
- CareerBot IT may create drafts
- CareerBot IT may send application emails as part of auto-apply
- CareerBot IT may not send recruiter conversation replies unless Sharon replies: send it / approved
